    ...
    ***************************************************************************** */
    ...
    var SliderPlainCamera = /** @class */ (function (_super) {
        ...
        function SliderPlainCamera(element, context, panels) {
            ...
            var cameraRect = _this._dom.rect();
            var source = checkTouchSupport() ? new y(element) : new _(element);
            _this._start = cameraRect.left;
            _this._width = cameraRect.width;
            _this._pan = new g().bind(source).on('input', _this._handleInput);
            return _this;
        }
