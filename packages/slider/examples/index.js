...
(function () {
    ...
    ***************************************************************************** */
    ...
    function initBasicSlider() {
        ...
        new Slider(element);
        n$1('#slider_basic_html').text("<div id=\"slider_basic\" class=\"slider\">\n  <ul class=\"camera\">\n    <li class=\"panel\">1</li>\n    <li class=\"panel\">2</li>\n    <li class=\"panel\">3</li>\n    <li class=\"panel\">4</li>\n    <li class=\"panel\">5</li>\n  </ul>\n</div>");
        setTimeout(function () {
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            console.log(window.__CPEmbed('.codepen-base'));
        }, 1000);
    }
    main();
