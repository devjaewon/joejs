(function () {
    ...
    ***************************************************************************** */
    ...
    var SliderPlainCamera = /** @class */ (function (_super) {
        ...
        SliderPlainCamera.prototype._recognizeRects = function (cameraRect) {
            ...
            for (var i = 0; i < this._panels.length; i++) {
                ...
                var leftGap = isFirst ? x - this._cameraX : x - prevX - prevWidth;
    ...
    function initBasicExample() {
        var element = s$2('#slider_basic').get(0);
        if (!element) {
            return;
        }
        new Slider(element);
        s$2('#code_basic ._code[data-target="html"]').text("<div id=\"slider_basic\" class=\"slider\">\n  <ul class=\"camera\">\n    <li class=\"panel\">1</li>\n    <li class=\"panel\">2</li>\n    <li class=\"panel\">3</li>\n    <li class=\"panel\">4</li>\n    <li class=\"panel\">5</li>\n  </ul>\n</div>");
        s$2('#code_basic ._code[data-target="css"]').text(".slider {\n  overflow: hidden;\n}\n.camera {\n  white-space: nowrap;\n  font-size: 0;\n}\n.panel {\n  display: inline-block;\n  width: 100%;\n  height: 200px;\n  vertical-align: top;\n}");
        s$2('#code_basic ._code[data-target="js"]').text("import Slider from '@kjojs/slider';\n\nconst slider = new Slider(\n  document.getElementById('slider_basic'),\n);");
    }
    function initSideMarginExample() {
        var element = s$2('#slider_sidemargin').get(0);
        if (!element) {
            return;
        }
        new Slider(element);
    ...
    function initCodeBoxes() {
        s$2('._btnCode').on('click', function (e) {
            var btnCode = s$2(e.target);
